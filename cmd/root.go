...
var rootCmd = &cobra.Command{
  Use:   "todos",
  Short: "A CLI tool to keep track of your daily todo's",
  Long: `todos is a simple CLI program that allows you to keep track
  of all the things you have to do. It allows for easy addition of tasks, 
  as well as a nice overview and reminders`,
